...
{
    public class SadFace : IUserJourney
    {
        ...
        public string Draw()
        {
            ...
            (int dx, int dy, int x1, int y1, int x2, int y2, int x, int y) = (coordinates.x - 5, coordinates.y + 10, coordinates.x - 5, coordinates.y,
                                                                             coordinates.x + 5, coordinates.y, coordinates.x + 5, coordinates.y + 10);
